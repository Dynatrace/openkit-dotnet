...
{
    /// <summary>
    /// VisualBasic wrapper class for wrapping <see cref="AppMonOpenKitBuilder"/> workarounding ambiguity error.
    /// </summary>
    /// <remarks>
    ...
    /// To workaround this problem this <see cref="AppMonOpenKitBuilderVB"/> wrapper class is introduced
    /// containing all non-obsolete public methods from <see cref="AppMonOpenKitBuilder"/>.
    /// </remarks>
    [Obsolete("Will be removed when AbstractOpenKitBuilder.WithModelID(string) is removed")]
    public class AppMonOpenKitBuilderVB
    {
        /// <summary>
        /// Wrapped <see cref="AppMonOpenKitBuilder"/>
        /// </summary>
        private readonly AppMonOpenKitBuilder wrappedBuilder;
        ...
        public AppMonOpenKitBuilderVB WithLogLevel(LogLevel logLevel)
        {
        ...
        /// <returns><code>this</code></returns>
        public AppMonOpenKitBuilderVB WithLogger(ILogger logger)
        {
        ...
        /// <returns><code>this</code></returns>
        public AppMonOpenKitBuilderVB WithApplicationVersion(string applicationVersion)
        {
        ...
        /// <returns><code>this</code></returns>
        public AppMonOpenKitBuilderVB WithOperatingSystem(string operatingSystem)
        {
        ...
        /// <returns><code>this</code></returns>
        public AppMonOpenKitBuilderVB WithManufacturer(string manufacturer)
        {
        ...
        /// <returns><code>this</code></returns>
        public AppMonOpenKitBuilderVB WithModelId(string modelId)
        {
        ...
        /// <returns><code>this</code></returns>
        public AppMonOpenKitBuilderVB WithBeaconCacheLowerMemoryBoundary(long lowerMemoryBoundary)
        {
        ...
        /// <returns><code>this</code></returns>
        public AppMonOpenKitBuilderVB WithBeaconCacheUpperMemoryBoundary(long upperMemoryBoundary)
        {
