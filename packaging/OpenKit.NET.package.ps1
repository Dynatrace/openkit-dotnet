...
# copy license
Copy-Item "..\LICENSE" -Destination $packagingContentFolderName

# Copy documentation
Copy-Item "..\" -Filter "*.md" -Destination $packagingContentFolderName
Copy-Item "..\docs" -Destination $packagingContentFolderName -Recurse
...
Get-ChildItem "..\src\openkit-dotnetcore-1.0\bin\Release\$dotNetCore10Name" | ForEach {
...
Get-ChildItem "..\src\openkit-dotnetcore-1.1\bin\Release\$dotNetCore11Name" | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetcore-2.0\bin\Release\$dotNetCore20Name | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetfull-3.5\bin\Release | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetfull-4.0\bin\Release | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetfull-4.5\bin\Release | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetfull-4.6\bin\Release | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetfull-4.7\bin\Release | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetpcl-4.5\bin\Release | ForEach {
...
Get-ChildItem ..\src\openkit-dotnetstandard-2.0\bin\Release\$dotNetStandard20Name | ForEach {
...
Get-ChildItem ..\src\openkit-dotnet-uwp\bin\Release | ForEach {
